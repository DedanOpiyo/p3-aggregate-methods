...
class Student:
    ...
    # aggregate method that counts the number of courses a Student is a part of.
    def course_count(self):
        return len(self._enrollments)
    
    # a method that would give us the average grade for a student across all the courses they are enrolled in. *WILL CAUSE ERROR. _grades IS ASSUMED.
...
class Enrollment:
    ...
    # aggregate method to the Enrollment class to figure out how many enrollments were done for any day students were enrolled. 
    @classmethod
